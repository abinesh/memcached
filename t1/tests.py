...
def normal_multinode_operations_scale_up():
    ...
    print raw_input(
        "Have you started added another node(11212) to the cluster??\nWait for split and migrate to complete")
    ...
    print raw_input(
        "Have you started added another node(11213) to the cluster??\nWait for split and migrate to complete")
...
def print_topologies():
    print "T1: A->B, B->C, C->D"
    print "T2: A->B, A->C, A->D"
    print "T3: A->B, B->C, A->D"
    pass
